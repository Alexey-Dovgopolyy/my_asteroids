...
//{
//#define BOOK_BUTTONTOSTRING_CASE(KEY) case sf::Mouse::KEY: return #KEY;

//    switch (button)
//    {
//        BOOK_BUTTONTOSTRING_CASE(Left)
//        BOOK_BUTTONTOSTRING_CASE(Middle)
//        BOOK_BUTTONTOSTRING_CASE(Right)
//    }
